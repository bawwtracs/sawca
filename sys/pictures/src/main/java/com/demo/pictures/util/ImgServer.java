...
public class ImgServer {
    ...
    public RequestImage addOrSearch(Path imgPath, String type, String operation, Long requestId) {
        ...
        try {
            ...
            return saveRequestImage(image, requestTime, responseTime, result, operation, requestId, type);
        } catch (Exception e) {
    ...
    private RequestImage saveRequestImage(File file, Long requestTime, Long responseTime, String result, String operation, Long requestId, String type) {
